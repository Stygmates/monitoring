...
class folderchooser():
    def init_layout(self, path):
        ...
        extension_label = QLabel("Extension to monitor")
        self.extension_lineedit = self.extension_lineedit()
        extension_layout = QVBoxLayout()
        extension_layout.addWidget(extension_label)
        extension_layout.addWidget(self.extension_lineedit)
        ...
        main_grid.addLayout(extension_layout)
    ...
    def monitor(self):
        ...
        if os.path.lexists(self.current_path_lineedit.text()):
            ...
            self.extension = self.extension_lineedit.text()
            self.path = self.current_path_lineedit.text()
